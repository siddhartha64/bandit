...
in this i sorted all files using sort and found the count of each string using uniq -c   conut i could have used -u which he retrive the single line which wasnt repeating<br>
